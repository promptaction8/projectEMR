            ...
            <div className="flex-col flex w-350 h-200">
                <div className="w-full h-32 flex items-center justify-center relative">
                    ...
                    <div className="absolute left-0 right-0 bottom-0 h-1">
                        <div className="h-full bg-gradient-to-r from-transparent via-blue-600 to-transparent"></div>
                    </div>
                </div>
                <div className="w-full flex-1 flex flex-col md:flex-row gap-4 md:gap-64 items-center justify-center border-white border-2 border-solid">
                    {/* 직원 로그인 박스 */}
                    <div className="w-full md:w-140 flex flex-col items-center p-4 border-2 border-solid border-white">
                    ...
                    {/* 환자 로그인 박스 */}
                    <div className="w-full md:w-140 h-auto flex flex-col items-center p-4 border-2 border-solid border-white">
                        <CiLogin className="text-9xl mb-10 text-[#0EA5E9]" />
                        ...
                        <Link
                            href={'/patient-login'}
                            className="bg-gray-100 border-2 border-blue-600 text-[#0EA5E9] py-3 px-8 rounded-lg text-3xl font-mono shadow-xl transition-transform transform hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#0EA5E9] focus:ring-opacity-50"
                        >
                            Patient Login
                        </Link>
                        <div className="relative w-full mt-40">
